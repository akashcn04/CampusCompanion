  ...
  return (
    <div className='relaive h-screen overflow-hidden bg-[url("/images/bg-image2.jpg")] bg-cover bg-center'>
      ...
      <div className='absolute z-10 top-10 left-10'>
        <p className='text-8xl font-bold mt-10 ml-2 lg:ml-4'><span className='text-cream'>Brain</span> <span className='text-dark-cream'>Bros.</span> </p>
        <p className='text-white text-3xl lg:text-9xl font-bold mt-2 lg:mt-10 ml-3'>Connect.Learn.Grow.</p>
        <p className='text-light-ivory text-3xl mt-1 ml-6 hidden lg:block'>"Unlock your potential with guidance from those who’ve been there."</p>

        <div className='flex flex-col absolute mt-32 gap-5 ml-2 lg:-right-32'>
